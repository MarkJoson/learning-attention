...
#   source file : fla/ops/kda/chunk.py
#   commit      : 0b27f7b
...
from _fla_kda_l2norm import l2norm_bwd, l2norm_fwd
from _fla_kda_compat import dispatch
from _fla_kda_common_gate import fused_beta_sigmoid, fused_beta_sigmoid_bwd
from _fla_kda_compat import FLACPContext
from _fla_kda_chunk_bwd import chunk_kda_bwd
from _fla_kda_chunk_fwd import chunk_kda_fwd
...
def chunk_kda(
    ...
    **kwargs,
    ...
    Examples::
        ...
        >>> from _fla_kda_compat import chunk_kda
