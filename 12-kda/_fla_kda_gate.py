...
#   source file : fla/ops/kda/gate.py
#   commit      : 0b27f7b
...
from _fla_kda_compat import exp
from _fla_kda_compat import softplus
from _fla_kda_compat import IS_AMD, autocast_custom_bwd, autocast_custom_fwd, autotune_cache_kwargs, check_shared_mem, input_guard
