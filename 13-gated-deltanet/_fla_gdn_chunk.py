# =============================================================================
# 来源标注 (Provenance) —— 本仓库 13-gated-deltanet（GDN / Gated DeltaNet 深度优化版，解耦自 fla）
# -----------------------------------------------------------------------------
# 完整拷贝自 fla-org/flash-linear-attention（Qwen3-Next 的线性注意力主干），**计算逻辑一字未改**，
# 仅把对 fla 框架的 import 改指向本地（_fla_gdn_* / 薄适配层 _fla_gdn_compat.py）。
# no-op dispatch 绕过后端分派、cp stub 绕过多卡 context-parallel，脱离 fla 包独立运行。
#   source repo : https://github.com/fla-org/flash-linear-attention
#   source file : fla/ops/gated_delta_rule/chunk.py
#   commit      : 0b27f7b
...
from _fla_gdn_l2norm import l2norm_bwd, l2norm_fwd
from _fla_gdn_chunk_delta_h import chunk_gated_delta_rule_bwd_dhu, chunk_gated_delta_rule_fwd_h
from _fla_gdn_chunk_o import chunk_bwd_dqkwg, chunk_bwd_dv_local, chunk_fwd_o
from _fla_gdn_common_gate import fused_beta_sigmoid, fused_beta_sigmoid_bwd
from _fla_gdn_compat import FLACPContext
from _fla_gdn_compat import (
    chunk_gated_delta_rule_bwd_dhu_pre_process,
    chunk_gated_delta_rule_fwd_h_pre_process,
    compress_h0,
    expand_h0,
)
from _fla_gdn_chunk_fwd import chunk_gated_delta_rule_fwd_intra
from _fla_gdn_gate import gdn_gate_bwd, gdn_gate_chunk_cumsum
from _fla_gdn_wy_fast import prepare_wy_repr_bwd, recompute_w_u_fwd
from _fla_gdn_compat import chunk_local_cumsum
from _fla_gdn_compat import RCP_LN2
from _fla_gdn_compat import prepare_chunk_indices
from _fla_gdn_compat import autocast_custom_bwd, autocast_custom_fwd, input_guard
...
def chunk_gated_delta_rule(
    ...
    **kwargs,
    ...
    Examples::
        ...
        >>> from _fla_gdn_compat import chunk_gated_delta_rule
