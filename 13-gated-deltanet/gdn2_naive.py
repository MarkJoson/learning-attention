...
# -----------------------------------------------------------------------------
# 完整拷贝自 fla-org/flash-linear-attention（GDN-2 参考实现，erase/write 双门控解耦），
# **计算逻辑一字未改**。这是 GDN-2 递归的 ground truth（token-by-token + chunk 两版）。
#   source repo : https://github.com/fla-org/flash-linear-attention
#   source file : fla/ops/gdn2/naive.py
